...
# A6 (Bloque A): el Stop ya no exige la acreditacion; casos INVERTIDOS a
# cierre (pines contra la reintroduccion).
...
caso_g8_full_raiz_untracked_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  rm -rf "$LAB/wt-tarea"
  ...
  lab_run stop claude "$(lab_payload_stop "$(_recibo_raiz "$LAB/wt-tarea" "$_sha")")"
  _afirma_cierre "artefactos sin versionar"
}

caso_g8_full_raiz_dirty_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  _sha="$(_wt_nuevo wt-tarea)"
  printf 'cambio sucio\n' >> "$LAB/wt-tarea/.saikit/decisiones/21.4.tsv"
  lab_run stop claude "$(lab_payload_stop "$(_recibo_raiz "$LAB/wt-tarea" "$_sha")")"
  _afirma_cierre "artefacto modificado tras el commit"
}

caso_g8_full_raiz_post_review_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  _sha="$(_wt_nuevo wt-tarea)"
  ...
  lab_run stop claude "$(lab_payload_stop "$(_recibo_raiz "$LAB/wt-tarea" "$_sha")")"
  _afirma_cierre "HEAD avanzo sobre el sha revisado"
}

caso_g8_full_raiz_ajena_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  ...
  _afirma_cierre "checkout ajeno con otro HEAD"
}

caso_g8_full_raiz_otro_head_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  _sha_tarea="$(_wt_nuevo wt-tarea)"
  _sha_otra="$(_wt_nuevo wt-otra)"
  lab_run stop claude "$(lab_payload_stop "$(_recibo_raiz "$LAB/wt-otra" "$_sha_tarea")")"
  _afirma_cierre "otro worktree en otro HEAD"
}

caso_g8_full_raiz_prefijo_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  _sha="$(_wt_nuevo wt-tarea)"
  ...
  _afirma_cierre "prefijo parecido sin repo"
}
...
caso_g8_full_raiz_symlink_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  _sha="$(_wt_nuevo wt-tarea)"
  mkdir -p "$LAB/fuera"
  ...
  _afirma_cierre "artefacto versionado como enlace afuera"
}

caso_g8_full_raiz_sin_sha_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  _sha="$(_wt_nuevo wt-tarea)"
  ...
  _afirma_cierre "raiz sin sha no acredita"
}
...
caso_g8_full_raiz_ignorada_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  _sha="$(_wt_nuevo wt-tarea)"
  ...
  _sha2="$(git -C "$LAB/wt-tarea" rev-parse HEAD)"
  lab_run stop claude "$(lab_payload_stop "$(_recibo_raiz "$LAB/wt-tarea" "$_sha2")")"
  _afirma_cierre "artefactos ignorados no estan en el arbol"
}
...
caso_g8_full_raiz_assume_unchanged_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  _sha="$(_wt_nuevo wt-tarea)"
  ...
  lab_run stop claude "$(lab_payload_stop "$(_recibo_raiz "$LAB/wt-tarea" "$_sha")")"
  _afirma_cierre "assume-unchanged esconde el cambio pero el disco no es el arbol"
}
...
caso_g8_full_raiz_replace_blob_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  _sha="$(_wt_nuevo wt-tarea)"
  ...
  lab_run stop claude "$(lab_payload_stop "$(_recibo_raiz "$LAB/wt-tarea" "$_sha")")"
  _afirma_cierre "git replace fabrica el contenido con status limpio"
}
...
caso_g8_full_raiz_autoconsistente_sin_veredicto_cierra() {
  limpiar_saikit
  _sembrar_turno_completo
  _sha="$(_repo_sin_veredicto wt-ajeno-auto)"
  lab_run stop claude "$(lab_payload_stop "$(_recibo_raiz "$LAB/wt-ajeno-auto" "$_sha")")"
  _afirma_cierre "repo ajeno autoconsistente sin veredicto sellado"
}

CASOS_G8="$CASOS_G8 caso_g8_full_raiz_acreditada_otro_cwd_cierra caso_g8_full_raiz_untracked_cierra caso_g8_full_raiz_dirty_cierra caso_g8_full_raiz_post_review_cierra caso_g8_full_raiz_ajena_cierra caso_g8_full_raiz_otro_head_cierra caso_g8_full_raiz_prefijo_cierra caso_g8_full_raiz_puntos_cierra caso_g8_full_raiz_symlink_cierra caso_g8_full_raiz_ignorada_cierra caso_g8_full_raiz_sin_sha_cierra caso_g8_full_sha_sin_raiz_legacy_cierra caso_g8_full_raiz_assume_unchanged_cierra caso_g8_full_raiz_replace_blob_cierra caso_g8_full_raiz_autoconsistente_sin_veredicto_cierra"
