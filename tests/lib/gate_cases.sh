...
caso_g2_credenciales_token_nuevas_se_redactan() {
  lab_sembrar 123456 0 0 0 ""
  lab_run tool claude "$(lab_payload_bash 'pytest --token ghp_ABCDEF1234567890abcdefABCDEF1234567890 --pat github_pat_ABCDEF1234567890abcdefABCDEF1234567890 --oauth gho_ABCDEF1234567890abcdefABCDEF1234567890 --ai sk-proj-abc123def456xyz7890123 --aws AKIAABCDEFGHIJKLMNOP --slack xoxb-1234567890-abcdefghijklmnop')"
  _igual "verified (el runner pytest sigue contando)" "$(lab_estado verified)" "1"
  _no_contiene "ghp no en log" "$(lab_log)" 'ghp_ABCDEF1234567890abcdefABCDEF1234567890'
  _no_contiene "github_pat no en log" "$(lab_log)" 'github_pat_ABCDEF1234567890abcdefABCDEF1234567890'
  _no_contiene "gho no en log" "$(lab_log)" 'gho_ABCDEF1234567890abcdefABCDEF1234567890'
  _no_contiene "sk-proj no en log" "$(lab_log)" 'sk-proj-abc123def456xyz7890123'
  _no_contiene "AKIA no en log" "$(lab_log)" 'AKIAABCDEFGHIJKLMNOP'
  _no_contiene "xoxb no en log" "$(lab_log)" 'xoxb-1234567890-abcdefghijklmnop'
