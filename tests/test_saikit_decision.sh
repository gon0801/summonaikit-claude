...
form_token() {
  case "$1" in
    ghp_)        printf 'ghp_ABCDEF1234567890abcdefABCDEF1234567890' ;;
    github_pat_) printf 'github_pat_ABCDEF1234567890abcdefABCDEF1234567890' ;;
    gho_)        printf 'gho_ABCDEF1234567890abcdefABCDEF1234567890' ;;
    sk-)         printf 'sk-proj-abc123def456xyz7890123' ;;
    AKIA)        printf 'AKIAABCDEFGHIJKLMNOP' ;;
    xoxb-)       printf 'xoxb-1234567890-abcdefghijklmnop' ;;
    xoxp-)       printf 'xoxp-1234567890-abcdefghijklmnop' ;;
    *)           printf '' ;;
  esac
}
...
bash "$tool" --append --task rastro --dir "$tmp" --etapa Diseno \
  --decision "usar el token ghp_ABCDEF1234567890abcdefABCDEF1234567890" \
  --por-que "el por que trae ghp_ABCDEF1234567890abcdefABCDEF1234567890" \
  --evidencia "la evidencia trae ghp_ABCDEF1234567890abcdefABCDEF1234567890" \
  --resultado ok
[ $? -eq 0 ] || malo "el append del rastro no salio 0"
grep -qF 'ghp_ABCDEF1234567890abcdefABCDEF1234567890' "$tmp/rastro.tsv" \
