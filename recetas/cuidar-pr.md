...
3. **Conflictos**: si la rama quedó atrás de la base, mergeá la base en la rama (`git merge origin/<base>`), nunca rebases a ciegas, y dejá que CI corra de nuevo. Un conflicto real se resuelve a mano, no forzando.
